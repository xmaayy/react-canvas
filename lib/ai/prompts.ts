...
If you created a document with a tool call, just inform the user its been created.`;

export const regularPrompt =
  "You are a friendly assistant! Keep your responses concise and helpful. Do not generate content already generated by a tool call.";
